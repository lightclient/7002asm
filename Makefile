...
build: $(GEAS)
	...
	# 8357
	mkdir -p bytecode/verification_key_registry
	$(GEAS) -a -no-nl -o bytecode/verification_key_registry/main.hex src/verification_key_registry/main.eas
	$(GEAS) -a -no-nl -o bytecode/verification_key_registry/ctor.hex src/verification_key_registry/ctor.eas
